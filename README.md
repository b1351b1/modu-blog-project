...
gantt
    ...
    section 모델 및 인증
    User 모델             :2025-10-03, 1d
    게시판 모델            :2025-10-03, 1d
    가입/로그인           :2025-10-03, 1d
    JWT 토큰 검증         :2025-10-03, 1d
    영어 문제 수집         :2025-10-03, 1d
    
    section CRUD 기능
    Problem 모델          :2025-10-06, 1d
    문제 관리 API         :2025-10-06, 2d
    게시글 CRUD          :2025-10-06, 4d
    댓글 기능 API         :2025-10-06, 2d
    
    section 추가 기능
    사용자 관리           :2025-10-10, 2d
    Redis 연결           :2025-10-10, 1d
    인기 문제 개싱        :2025-10-10, 1d
    페이지네이션          :2025-10-10, 1d
    영어 문제 입력        :2025-10-10, 1d
