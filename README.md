...
![ERD](https://i.imgur.com/your-erd-image.png)
...
gantt
    ...
    section 초기 준비
    프로젝트 세팅           :2025-10-01, 1d
    레포 구성              :2025-10-01, 1d
    
    section 설계
    API 명세서             :2025-10-02, 1d
    ERD 작성              :2025-10-02, 1d
    
    section 모델 및 인증
    User 모델             :2025-10-03, 3d
    게시판 모델            :2025-10-03, 3d
    기입/로그인           :2025-10-03, 3d
    JWT 토큰 검증         :2025-10-03, 3d
    영어 문제 수집         :2025-10-03, 3d
    
    section CRUD 기능
    Problem 모델          :2025-10-06, 4d
    문제 관리 API         :2025-10-06, 4d
    게시글 CRUD          :2025-10-06, 4d
    댓글 기능 API         :2025-10-06, 4d
    
    section 추가 기능
    사용자 관리           :2025-10-10, 2d
    Redis 연결           :2025-10-10, 2d
    인기 문제 개싱        :2025-10-10, 2d
    페이지네이션          :2025-10-10, 2d
    영어 문제 입력        :2025-10-10, 2d
    
    section 테스트
    API 테스트           :2025-10-12, 2d
    Redis 테스트         :2025-10-12, 2d
    버그 수정            :2025-10-12, 2d
    프론트 연동          :2025-10-12, 2d
    
    section 프론트/문서
    HTML/CSS            :2025-10-14, 2d
    UI 연동             :2025-10-14, 2d
    코드 정리           :2025-10-14, 2d
    README 작성         :2025-10-14, 2d
    
    section 발표
    발표 자료 제작       :crit, 2025-10-15, 1d
    시연 시나리오        :crit, 2025-10-15, 1d
